  ...
  return (
    <div className="profile_container">
      ...
      <div className="profile_information_container">
        ...
        <span className="profile_information_item">Email :</span>
        <hr className="profile_information_line"></hr>
        <span className="profile_information_item">Country :</span>
        <hr className="profile_information_line"></hr>
        <span className="profile_information_item">State :</span>
        <hr className="profile_information_line"></hr>
        <span className="profile_information_item">City :</span>
        <hr className="profile_information_line"></hr>
        <span className="profile_information_item">Profession :</span>
        <hr className="profile_information_line"></hr>
